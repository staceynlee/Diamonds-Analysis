...
# Your first task is to create a scatterplot of price vs x, y, or z
...
# Create a scatterplot of price vs carat and omit the top 1% of price
# and carat values.
...
# Also, exclude diamonds with a volume of 0. Adjust the transparency of the
